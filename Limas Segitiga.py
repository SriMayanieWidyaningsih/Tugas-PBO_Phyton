...
# Label Tinggi Limas Segitiga
tinggilimas = Label(frame, text="Tinggilimas:")
tinggilimas.grid(row=4, column=0, sticky=W, padx=5, pady=5)
# Textbox TInggi Limas Segitiga
txttinggilimas = Entry(frame)
txttinggilimas.grid(row=4, column=1)
